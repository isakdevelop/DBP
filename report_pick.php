...
<head>
    ...
    <link href="./css/report_pick.css" type="text/css" rel="stylesheet" >
    ...
    <div class="main_page">
        <div class="sub_frame">
            <div class="pick_frame">
                <div class="basic" onclick="location.href='report_missing_person.php'"></div>
                <div class="admin" onclick="location.href='report_criminal.php'"> </div>
            </div>
            <div class="pick_frame">
                <h3 class="pick_frame_text" onclick="location.href='report_missing_person.php'">실종자 제보 목록</h3>
                <h3 class="pick_frame_text" onclick="location.href='report_criminal.php'">수배자 제보 목록</h3>
            </div>
