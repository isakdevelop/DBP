...
$sql = "SELECT idx, id, idx_ref_mp AS irp, name, content, title, pw FROM wanted_report WHERE name = '$name'";
    ...
    <script>
      ...
      function modify_func(){
        ...
        if(ispol == true){
          ...
          if(result){
            location.href = "https://jj7932.cafe24.com/dbp/cm_modify_process.php?title="+title_value+"&content="+content_value+"&idx="+select_title_idx+"&name="+m_name;;
          }
        }
        else {
      ...
      function delete_func(){
        if(ispol == true){
          ...
          if(result){
            location.href = "https://jj7932.cafe24.com/dbp/cm_list_delete_process.php?idx="+select_title_idx+"&name="+m_name;;
          }
        }
        else {
          var pw_value = document.getElementById('password').value;
