...
$crime = $_GET['crime'] ?? '';
$place = $_GET['place'] ?? '';
echo "<script>console.log('$place');</script>";
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div id="content">
      <form action="./modify_Wanted_Process.php?idx=<?=$idx?>" method="post" name="form" enctype="multipart/form-data" novalidate>
        ...
        <span class="box_int_photo">
          ...
          <div id="image_container">
            <img src="<?=$photo?>" id="thumbnail_img" style="height:250px; weight:200px;"/>
          </div>
        </span>
        <h3 class="join_title"><label for="name">성명<small> (필수)</small></label></h3>
        <span class="box int_name">
            <input type="text" id="name" name="name" class="int" maxlength="20" value="<?=$name?>"placeholder="홍길동">
        </span>
        <h3 class="join_title"><label for="crime">죄목<small> (필수)</small></label></h3>
        <span class="box int_crime">
            <input type="text" id="crime" name="crime" class="int" maxlength="10" value="<?=$crime?>" placeholder="살인">
        </span>
        <h3 class="join_title"><label for="Place_of_Registration">등록지<small> (필수)</small></label></h3>
        <span class="box int_Place_of_Registration">
            <input type="text" id="Place_of_Registration" name="Place_of_Registration" class="int" value="<?=$place?>" maxlength="40" placeholder="천안시 서북구 공대길 27">
        </span>
        <h3 class="join_title"><label for="address">주소<small> (필수)</small></label></h3>
        <span class="box int_address">
            <input type="text" id="address" name="address" class="int" value="<?=$address?>" maxlength="40" placeholder="천안시 서북구 천안대로 1223-24">
        </span>
        <!-- JOIN BTN-->
        <div class="btn_area">
