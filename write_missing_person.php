...
<head>
    ...
    <link href="./css/write_missing_person.css" type="text/css" rel="stylesheet" >
    ...
    <div class="main_page">
        <div class="sub_frame">
            ...
            <section class="notice_write col-12 mx-auto">
                <form id="write_form" action="write_missing_person_process.php?idx=<?=$idx?>" method="post">
                    <h2 style="text-align: center; font-family: '마초체';">실종자 제보하기</h2>
